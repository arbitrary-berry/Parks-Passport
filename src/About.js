        ...
        <Grid.Column width={2}></Grid.Column>
              ...
              <Card.Content>
                <h2>Future Features:</h2>
                  <p>
                      ...
                      <li>A click feature on the <AiFillHeart /> in each Park and have that add to the WishList 
                      ...
                      <li><RiHeartsFill /> as a click feature on the park card to mark you'd like to go back to that park.</li>
                      <li><BsPinMapFill /> as a click feature on the park card to mark you've visited that park.</li>
                  </p>
              </Card.Content>
          </Card>
          </Grid.Column>
          <Grid.Column width={2}>
                ...
                <Card>
                    ...
                    <Card.Content>
                        <a href="https://github.com/amorse110"><BsGithub /></a> <a href="https://github.com/amorse110"><BsLinkedin /></a></Card.Content>
                    </Card>
                </Grid.Column>
          <Grid.Column width={2}></Grid.Column>
        </Grid.Row>
